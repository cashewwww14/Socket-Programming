# Deskripsi: Server mendengarkan koneksi di localhost:12345, menerima koneksi dari client,
# mengirim pesan "Hello, Client!", lalu menutup koneksi.
# Input: Tidak ada input langsung (server hanya menunggu koneksi client).
# Output (contoh):
...
if __name__ == '__main__':
    ...
    # Uncomment this if you want to run the server manually
    # start_server()
