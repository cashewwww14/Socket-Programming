# Deskripsi: Client terhubung ke server di localhost:12345, mengirim pesan, 
# lalu menerima kembali pesan yang sama (echo), dan mencetaknya.
# Input: Tidak ada input langsung; pesan dikirim melalui socket.
# Output (contoh): Received from server: Hello, Echo Server!
