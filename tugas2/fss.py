# Deskripsi: Client mengirim nama file (dari argumen command line) ke server di localhost:12345,
# menerima isi file (atau pesan "File not found.") lalu mencetaknya ke konsol.
# Input: Argumen command-line berupa nama file.
# Output (contoh):
...
def handle_connection(conn, addr):
    ...
    try:
        ...
        # get file content from files variable
