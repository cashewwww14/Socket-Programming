# Deskripsi: Server mendengarkan di localhost:12345, menerima koneksi dari client,
# dan mencetak pesan "Hello, Server!" yang dikirim client.
...
if __name__ == '__main__':
    ...
    # Uncomment this if you want to run the server program
    # start_server()
