# Deskripsi: Server mendengarkan di localhost:12345, menerima pesan dari client,
# lalu mengirim kembali pesan yang sama (echo) sebelum menutup koneksi.
# Input: Tidak ada input langsung; pesan diterima melalui socket.
# Output: Tidak ada output ke konsol; hanya mengirim balik pesan yang diterima ke client.
