    ...
    while True:
        ...
        for notified_socket in read_sockets:
            ...
            if notified_socket == server_socket:
                ...
                print('Accepted new connection from {}:{}, nickname: {}'.format(*client_address, user.decode()))
            else:
                ...
                print(f'Received message from {user.decode()}: {message.decode()}')
                ...
                full_message = f"{user.decode()}: {message.decode()}".encode()

                # first argument = full_message
                # second argument = the socket ready
                # third argument = clients dictionary
                broadcast(full_message, notified_socket, clients)
